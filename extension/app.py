...
def add_cors_headers(response):
    # Browser extensions run on a chrome-extension:// origin, which counts
    # as cross-origin from the server's perspective. Without these headers,
    # the browser blocks the popup's fetch() call to this server entirely --
    # this isn't optional for the extension to work.
