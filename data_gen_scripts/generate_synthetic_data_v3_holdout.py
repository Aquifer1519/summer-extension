...
OUTPUT_FILE = Path("synthetic_tweets_2500_holdout.json")
...
FORM_WEIGHTS = {
    "direct reaction": 0.18,
    "personal observation": 0.16,
    "brief opinion": 0.14,
    "question": 0.12,
    "reply-like disagreement": 0.18,
    "dry joke or sarcasm": 0.05,
    "sentence fragment": 0.10,
    "local practical complaint": 0.04,
    "brief supportive reaction": 0.03,
}
...
General rules:
For casual_lowercase and internet_reply profiles, do not sound like a policy
essay. Prefer short reactions, imperfect punctuation, contractions, occasional
slang, and references to an ongoing political conversation. Do not force slang
into every post.
For medium and long posts, write two or three natural social-media sentences.
A post may explain a concern or tradeoff, but do not write an academic essay,
list arguments mechanically, or use formal report language.
...
Casual style guide:
- "standard": Natural political social-media writing.
- "casual_lowercase": Informal lowercase typing, contractions, incomplete
  punctuation, and text-message style are acceptable.
- "internet_reply": Short reaction/reply style. It may refer vaguely to an
  ongoing political discussion, speech, interview, debate, post, or headline.
  Natural slang is allowed, such as "idk", "tbh", "rn", "gonna", "bro", "not
  me", "wild", or "cool cool". Do not force slang into every post.
- "short_reaction": Terse, blunt, fragmentary, or low-context posts are fine.
- "emoji_reaction": One or two emojis may appear naturally.
